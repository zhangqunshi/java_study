...
//	/**
//	 * 使用有限制的通配符“? super”，可以接受任何Child及其父类的对象
//	 * @param collect
//	 */
//	public static void printNames(List<? super Child> collect){
//		if (collect == null){
//			return;
//		}
//		for(Object parent : collect){
...
//	}
	...
	public static void main(String[] args) {
		...
		String[] xxx = { "55", "66", "77", "88", "99" };
		List yyy = new ArrayList();
		yyy.add(new Integer(29));
		yyy.add("String29");
		
		// 转换整型数组
		List<Integer> result_I = arrayToList(iObjs);
		List<String> result_s = arrayToList(xxx);
